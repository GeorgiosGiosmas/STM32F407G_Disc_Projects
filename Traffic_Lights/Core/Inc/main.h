...
/*
 * @brief This function configures the GENERAL TIMER5 which is used for blinking the LEDS via Interrupts.
 */
ReturnStatus Timer_Configuration(TIM_HandleTypeDef *timer);

/*
 * @brief This function configures the UART4 peripheral.
 */
